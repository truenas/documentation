<!-- 
EXEMPLARY REFERENCE DOCUMENTATION: Cloud Credentials Screens
Source: /content/SCALE/SCALEUIReference/Credentials/BackupCredentials/CloudCredentialScreens.md

WHY THIS IS AN EXCELLENT REFERENCE EXAMPLE:
1. **Comprehensive Field Documentation**: Every UI element is documented with clear descriptions
2. **Logical Organization**: Groups related settings by provider/authentication method
3. **Consistent Table Format**: Uses {{< truetable >}} consistently for all field descriptions
4. **Clear Section Headers**: Uses H2-H4 hierarchy to organize different screens/sections
5. **Screenshot Integration**: Proper use of {{< trueimage >}} with descriptive alt text
6. **Cross-References**: Links to related tutorials and external documentation
7. **Expandable Sections**: Uses {{< expand >}} shortcode effectively for detailed settings
8. **UI Element Identification**: Clearly identifies buttons, fields, and icons
9. **Include File Usage**: Proper use of {{< include file >}} for shared content
10. **Descriptive Language**: Explains what each field does and when to use it

STYLE GUIDE PATTERNS DEMONSTRATED:
- Reference documentation structure (Widget > Screen > Settings sections)
- Consistent field description format in tables
- Bold formatting for UI elements (**Field Name**, **Button Name**)
- Descriptive alt text for images
- Cross-references to related tutorials
- Use of expandable sections for complex settings
- Clear hierarchy with H2 for main sections, H3 for subsections
- Include files for reusable content
- Material icons formatting for UI buttons
-->

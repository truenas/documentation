<!-- 
EXEMPLARY COMPLEX REFERENCE DOCUMENTATION: NVMe-oF Share Screens
Source: /content/SCALE/SCALEUIReference/Shares/nvme-of-screens.md

WHY THIS IS AN EXCELLENT REFERENCE DOCUMENTATION EXAMPLE:
1. **Comprehensive Screen Documentation**: Documents all related screens and dialogs systematically
2. **Screen-Level Organization**: Structures content around UI screens with widgets and dialogs within
3. **Hierarchical UI Documentation**: Uses clear H2-H4 hierarchy for screens > widgets > dialogs > settings
4. **Consistent Table Documentation**: Uses {{< truetable >}} for all field descriptions
5. **Screenshot Integration**: Excellent use of {{< trueimage >}} for every screen/dialog
6. **Material Icons Documentation**: Properly documents Material Design icons with proper formatting
7. **Expandable Settings Sections**: Effective use of {{< expand >}} for detailed field information
8. **Cross-Reference Navigation**: Clear navigation between related screens
9. **Include File Usage**: Proper use of {{< include file >}} for shared content
10. **Complete UI Coverage**: Documents every button, field, and interaction element within screens
...
- Bold formatting for all UI elements (**Screen Name**, **Button**, **Field**)
...
- Include files for reusable content blocks
- Proper cross-references between related screens
- Descriptive headings that indicate UI element types (Screen, Widget, Dialog)
-->

...
async function initPageFind() {
    pagefind = await import("https://www.truenas.com/docs/scale/25.10/pagefind/pagefind.js");
    pagefind.init();
    ...
    try {
        ...
        if (paginatedSlicedResults.length === 0) {
            ...
            paginatedSlicedResults.forEach((result, index) => {
                ...
                let coreIcon = '<img src="https://www.truenas.com/docs/scale/25.10/favicon/TN-favicon-32x32.png" alt="TrueNAS CORE" title="TrueNAS CORE" class="icon">';
                let scaleIcon = '<img src="https://www.truenas.com/docs/scale/25.10/favicon/TN-favicon-32x32.png" alt="TrueNAS" title="TrueNAS" class="icon">';
                let tcIcon = '<img src="https://www.truenas.com/docs/scale/25.10/favicon/TC-favicon-32x32.png" alt="TrueCommand" title="TrueCommand" class="icon">';

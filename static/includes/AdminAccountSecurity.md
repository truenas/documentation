...
See [Security Recommendations](https://www.truenas.com/docs/solutions/optimizations/security/) and [Allowing Sudo Commands]({{< relref "AdminRoles/#allowing-sudo-commands" >}}) for more information.

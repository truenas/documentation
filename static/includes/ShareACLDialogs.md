...
{{< hint type=info title="Strip ACL from Dataset Warning" >}}
...
Alternatively, close the **Add SMB** screen, go to the **Datasets** screen, select the same dataset, locate the **Permissions** card, and then click **Edit** to open the **Edit ACL** screen.

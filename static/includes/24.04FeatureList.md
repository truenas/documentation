...
* New Community feature: SCALE [Sandboxes]({{< relref "/SCALE/SCALETutorials/Apps/Sandboxes.md" >}}) provide a similar functionality to TrueNAS 13 jails or Linux LXC containers.
...
* ZFS ARC memory allocations are updated and behave identically to TrueNAS 13.

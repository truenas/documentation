...
**Add Listen** shows the **Add** button, which shows the **IP Address** field where you add the IP address and netmask (CIDR) for the portal.

{{< expand "Portal Basic Info Settings" "v" >}} {id="iscsi_portals_add-basic"}
{{< truetable >}}
| Setting | Description |
|---------|-------------|

...
| Setting | Description |
|---------|-------------|
| **From Email** | The email address to use for sending emails. You must first [configure the user account email]({{< ref "SettingUpSystemEmail" >}}) in [**Credentials > Users**]({{< ref "LocalUsersScreensSCALE" >}}). |

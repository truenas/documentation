...
**Important**: Enabling this feature on shares with existing data may cause unexpected behavior for files that were written without name mangling enabled. Test thoroughly before applying to production shares with existing content.

...
Click on **My API Keys** <span class="material-icons">laptop</span> to go to the [User API Keys]({{< ref "/TopToolbar/Settings/APIKeysScreen" >}}) screen.
...
See [API Keys]({{< ref "/TopToolbar/Settings/APIKeysScreen" >}}) for more information on adding or managing API keys.
{{< /expand >}}

...
The TrueNAS UI does not have a **Minutes** field, but you can specify minutes within the **Hours** field using the [CRON syntax](#examples-of-cron-syntax) described below.

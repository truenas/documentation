...
| **Certificate** | Select an SSL (CORE) [certificate]({{< relref "/UIReference/System/Certificates.md" >}}) or (SCALE) [certificate](https://www.truenas.com/docs/scale/scaleuireference/credentials/certificates/certificatesscreensscale/) created or imported in (CORE) **System > Certificates > Add** or (SCALE) **Credentials > Certificates** for secure S3 connections. |

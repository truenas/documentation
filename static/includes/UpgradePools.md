...
* Upgrading can affect data.
  Before performing any operation that affects data on a storage disk, always [back up]({{< ref "/SCALE/DataProtection" >}}) data first and verify the backup integrity.

...
[Zpool layout]({{< relref "CreatePoolScale.md#about-data-vdev-layouts" >}}) (the organization of LUNs and volumes, in TrueNAS/ZFS parlance) is outside of the scope of this guide. 

...
* **Drive-Managed SMR (DM-SMR)** and **Host-Aware SMR (HA-SMR)** drives function poorly with TrueNAS, and the TrueNAS team does not recommend them. Expect degraded write performance and longer, less reliable resilver operations. 

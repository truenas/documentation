...
Use the **Edit Alert Service** screen to modify settings for a service. Select the <span class="material-icons">edit</span> icon for the service to display the **Edit Alert Service** screen.

...
| **Reserved space for this dataset**<br> **Reserved space for this dataset and all children** | Sets a rserve of additional space for datasets that contain logs that could eventually take up all the available free space. **0** is unlimited. |
{{< /truetable >}}
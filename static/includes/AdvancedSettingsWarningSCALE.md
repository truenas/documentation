...
Make sure you are comfortable with ZFS, Linux, and system [configuration, backup, and restoration]({{< ref "/SCALE/SystemSettings/General" >}}) before making any changes.
{{< /hint >}}

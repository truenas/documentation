...
All TrueNAS users should [create an administrator account]({{< ref "/SCALETutorials/Credentials/ManageUsers" >}}) with all required permissions and begin using it to access TrueNAS.

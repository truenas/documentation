...
All TrueNAS users should [create an administrator account]({{< ref "/SCALE/SCALETutorials/Credentials/ManageUsersSCALE" >}}) with all required permissions and begin using it to access TrueNAS.

...
All TrueNAS users should [create an administrator account]({{< ref "/Credentials/Users/ManageUsers" >}}) with all required permissions and begin using it to access TrueNAS.

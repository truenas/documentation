...
All TrueNAS users should [create an administrator account]({{< ref "/SCALE/Credentials/Users/ManageUsers" >}}) with all required permissions and begin using it to access TrueNAS.

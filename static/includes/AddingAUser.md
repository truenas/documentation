...
It uses the user account credentials to access data shared with [SMB]({{< ref "/Shares/SMB" >}}).
...
2. Set the level of access given to this user from the options provided.   
   **SMB Access** is selected by default, and required for a user to have access to an SMB share.
   ...
   Select **WebShare** to give this user access to a [WebShare]({{< ref "/Shares/WebShare/_index.md" >}}).

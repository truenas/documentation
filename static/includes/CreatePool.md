...
You can rename your enclosure on the [Enclosure Screen]({{< relref "EnclosureScreensSCALE.md" >}}) to include the rack an U number in the name, which helps identify the physical location while in the pool creation screen.
{{< /hint >}}

...
[NVMe over Fabric]({{< ref "SCALE/SCALETutorials/Shares/NVMe-oF/_index.md" >}}) support includes NVMe/TCP for Community Edition and NVMe/RDMA for Enterprise hardware.
...
See [NVIDIA GPU Support]({{< ref "/SCALE/GettingStarted/SCALEReleaseNotes.md#nvidia-gpu-support" >}}) for compatibility details.

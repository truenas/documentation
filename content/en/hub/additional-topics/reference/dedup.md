...
<table class="blueTable">
	...
	<tbody>
		...
		<tr>
			...
			<td><code>gstat</code> on console will often show large amounts of I/O, either for devices that contain DDT data, or for the pool generally (if special vdevs are not defined).</td>

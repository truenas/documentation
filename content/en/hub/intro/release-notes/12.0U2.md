...
The Enterprise Update train is being activated for this release on February 23, 2021! TrueNAS Enterprise customers are encouraged to upgrade their systems to get the latest performance improvements, bug fixes, and security enhancements. Enterprise customers can [contact iXsystems Support]({{< relref "/hub/initial-setup/support.md#contacting-ixsystems-support" >}}) for assistance with upgrading their TrueNAS systems.

...
<body class="ql-editor ql-editor-view" style="font-size:14px;">
    <html>
        <body>
			...
			<td>Our team is aware of some performance regressions when using Intel and Chelsio Network Devices on 12.0, work is being done to resolve those issues and a hotfix release will be issued when complete.</td>
		    </tr>
                </tbody>
            </table>
        </body>

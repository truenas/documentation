...
With the U1 release, TrueNAS Enterprise customers can begin manually updating their systems to TrueNAS 12.0. For assistance with the Enterprise update process, please [contact iX Support](/hub/initial-setup/support/#contacting-ixsystems-support). The Enterprise 12.0 update train will be activated soon after this release. To stay informed about upcoming TrueNAS release dates, check the [TrueNAS roadmap](/hub/intro/truenas-roadmap/)!

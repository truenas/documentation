...
[TrueNAS SCALE](/hub/scale/scaleintro/index.md) uses much of the same TrueNAS CORE source code, but adds a few different capabilities which are defined by this acronym:

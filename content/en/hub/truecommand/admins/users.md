...
To create a new user account, open the **Configure** <i class="fa fa-cog" aria-hidden="true"></i> menu and click **Users > + NEW USER**.
...
To configure account details and permissions, open the **Configure** <i class="fa fa-cog" aria-hidden="true"></i> menu, click **Users** and **Edit user** <i class="fas fa-pen"></i>.
...
To create a team, open the **Configure** <i class="fa fa-cog" aria-hidden="true"></i> menu and click **TEAMS** > **+ NEW TEAM**.
...
To adjust the team members or permissions, open the **Configure** <i class="fa fa-cog" aria-hidden="true"></i> menu and click **Teams** > **Edit team** <i class="fas fa-pen"></i>.

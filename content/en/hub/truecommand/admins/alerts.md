...
To see all alerts that TrueCommand has discovered, open the **Configure** <i class="fa fa-cog" aria-hidden="true" title="gear"></i> menu and click **All Alerts**.
...
Administrator accounts can delete an alert by clicking **Delete** <i class="fa fa-trash" aria-hidden="true" title="trash can"></i>.
Deleting an alert cannot be undone.
To delete multiple alerts, select each alert and click **Delete** <i class="fa fa-trash" aria-hidden="true" title="trash can"></i>.
...
To configure an alert service plugin, open the **Configure** <i class="fa fa-cog" aria-hidden="true" title="gear"></i> menu and click **Alert Services**.

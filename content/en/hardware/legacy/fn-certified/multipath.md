...
If higher availability is needed, a dual controller system like the [M-Series]({{< relref "mseries-3g.md" >}}) should be used.
...
If any existing FNC customers have questions about this issue, please discuss in the [forums](https://www.truenas.com/community/) or [contact us]({{< relref "/hub/initial-setup/support#contacting-ixsystems-support" >}}).

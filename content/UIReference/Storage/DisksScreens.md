...
Use **WIPE** to delete obsolete data off an unused disk. This option does not display unless your disk is unused. See [Wiping a Disk]({{< ref "/CORETutorials/Storage/Disks/DiskWipe" >}}) for more information on how to use this function. 
...
See [Import Disks]({{< ref "/CORETutorials/Storage/ImportDisk" >}}) for more information on importing a disk into your TrueNAS.

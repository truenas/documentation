...
For Cloudflare, enter either your **Cloudflare Email** and **API Key**, or enter an **API Token**. If you create an [API Token](https://dash.cloudflare.com/profile/api-tokens), make sure to give the token the permission Zone.DNS:Edit as it’s [required by certbot](https://certbot-dns-cloudflare.readthedocs.io/en/stable/).

...
The **System > Audit** screen lists all session, user, or SMB events.
...
To configure Audit storage and retention settings, go to **System > Advanced**, then click **Configure** on the [**Audit**]({{< relref "/SCALEUIReference/SystemSettings/AdvancedSettingsScreen.md#audit-widget" >}}) widget.

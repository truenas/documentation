...
TrueNAS [applications]({{< relref "/SCALETutorials/Apps/_index.md" >}}) also use separate upgrade and container image management methods to provide app update and rollback features.

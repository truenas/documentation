...
The [Rsyncd](https://www.truenas.com/docs/truenasapps/communityapps/rsyncd/) application is available in situations where configuring TrueNAS as an rsync server with an rsync module is necessary.

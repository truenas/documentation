...
You must have:
* All system [storage]({{< relref "/SCALETutorials/Storage/" >}}) configured and ready to receive or send data.
...
See the [Cloud Credentials]({{< relref "/SCALETutorials/Credentials/BackupCredentials/AddCloudCredentials" >}}) article for instructions on adding a backup cloud credential.

...
We recommend organizing your pool with datasets before configuring [data sharing]({{< ref "/SCALEUIReference/Shares/" >}}), as this allows for more fine-tuning of access permissions and using different sharing protocols.
...
Dataset quota [alerts]({{< ref "/SCALEUIReference/TopToolbar/Alerts/" >}}) are based on the percentage of storage used.
...
The [Datasets Screen]({{< ref "/SCALEUIReference/Datasets/" >}}) article describes each option in detail.

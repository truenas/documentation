...
To view drive health status, go to the **Storage** dashboard and view the [Disk Health card](https://www.truenas.com/docs/scale/storage/storagedashboardscreens/#disk-health-widget).

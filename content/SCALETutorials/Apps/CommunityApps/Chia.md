...
See [Creating a Dataset]({{< ref "DatasetsSCALE" >}}) for information on correctly configuring the datasets.
...
If manually creating and using datasets, follow the instructions in [Creating a Dataset]({{< ref "DatasetsSCALE" >}}) to correctly configure the datasets.

...
If you're looking for guest access functionality, see the [Guest Access]({{< relref "/SCALE/SCALETutorials/Shares/SMB/_index.md#guest-access" >}}) section in the main SMB tutorial.
{{< /hint >}}
{{< /expand >}}

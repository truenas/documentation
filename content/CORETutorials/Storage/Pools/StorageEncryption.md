...
{{< trueimage src="/images/CORE/12.0/StoragePoolsAddCreateEncryptionCiphers.png" alt="Choosing an encryption cipher" id="Choosing an encryption cipher" >}}
...
{{< trueimage src="/images/CORE/12.0/StoragePoolsDatasetAdd.png" alt="New Dataset Options" id="New Dataset Options" >}}

In the **Encryption Options** area, clear the **Inherit** checkbox, then select **Encryption**.

{{< trueimage src="/images/CORE/12.0/StoragePoolsCreateDatasetEncryptionOptions.png" alt="Dataset Encryption Options" id="Dataset Encryption Options" >}}
...
{{< trueimage src="/images/CORE/12.0/StoragePoolsDatasetLockOptions.png" alt="Dataset Locking Options" id="Dataset Locking Options" >}}
...
{{< trueimage src="/images/CORE/12.0/StoragePoolsDatasetUnlockOptions.png" alt="Dataset Unlock Options" id="Dataset Unlock Options" >}}
...
{{< trueimage src="/images/CORE/12.0/StoragePoolsDatasetUnlockSuccess.png" alt="Dataset Unlock Success" id="Dataset Unlock Success" >}}

{{< expand "Example" >}}

{{< trueimage src="/images/CORE/12.0/EncrytionExample1.png" alt="Encrypted locked Datasets" id="Encrypted locked Datasets" >}}
...
{{< trueimage src="/images/CORE/12.0/EncrytionExample2.png" alt="Password for locked Datasets" id="Password for locked Datasets" >}}
...
{{< trueimage src="/images/CORE/12.0/EncrytionExample3.png" alt="Successfully unlocked Datasets" id="Successfully unlocked Datasets" >}}
...
{{< trueimage src="/images/CORE/12.0/EncryptionKeyBackupWarning.png" alt="Encryption Backup Warning" id="Encryption Backup Warning" >}}
#### Pool Key File
...
{{< trueimage src="/images/CORE/12.0/StoragePoolsDatasetEncryptionPassphrase.png" alt="Dataset Encryption Passphrase Options" id="Dataset Encryption Passphrase Options" >}}

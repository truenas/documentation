...
[Create a new pool]({{< ref "/CORETutorials/Storage/Pools/#creating-a-pool" >}}) and set **Encryption** in the **Pool Manager**.
...
<!-- TrueNAS Enterprise users can connect a Key Management Interoperability Protocol KMIPref "/UIReference/System/KMIP.md" server to centralize keys when they are not using passphrases to unlock a dataset or zvol.-->
...
{{< hint type=tip >}}
This does not affect TrueNAS Enterprise installs with KMIPref "/UIReference/System/KMIP.md".
{{< /hint >}}
-->

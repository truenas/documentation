...
These are needed when configuring an [iSCSI Share]({{< ref "AddingiSCSIShare" >}}).
...
See [Zvols Screen]({{< ref "ZvolsScreen" >}}) for more information on zvol settings.
...
When the zvol is created with [encryption]({{< ref "StorageEncryption" >}}) enabled, additional **Encryption Actions** are displayed.

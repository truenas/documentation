...
These are needed when configuring an [iSCSI Share]({{< relref "/CORETutorials/Sharing/iSCSI/AddingiSCSIShare.md" >}}).
...
See [Zvols Screen]({{< relref "/UIReference/Storage/Pools/ZvolsScreen.md" >}}) for more information on zvol settings.
...
When the zvol is created with [encryption]({{< relref "/CORETutorials/Storage/Pools/StorageEncryption.md" >}}) enabled, additional **Encryption Actions** are displayed.

...
Taking snapshots requires the system have all [pools]({{< ref "/CORETutorials/Storage/Pools/" >}}), [datasets]({{< ref "/CORETutorials/Storage/Pools/datasets" >}}), and [zvols]({{< ref "zvols" >}}) already configured.

## Creating a Single Snapshot

{{< hint type=tip >}}
Consider making a [Periodic Snapshot Task]({{< ref "PeriodicSnapshotTasks" >}}) to save time and create regular, fresh snapshots.
{{< /hint >}}

...
| Name | Description |
|---------|-------------|
| **Edit** | Opens the [share creation screen]({{< relref "/CORETutorials/Sharing/SMB/SMBShare.md" >}}) to reconfigure the share or disable it. |
...
This ACL defines the user accounts or groups that own or have specific [permissions]({{< relref "/CORETutorials/Storage/Pools/Permissions.md" >}}) to the shared dataset.

...
| Name | Description |
|---------|-------------|
| **Edit** | Opens the [share creation screen]({{< ref "/CORETutorials/Sharing/SMB/SMBShare" >}}) to reconfigure the share or disable it. |
...
This ACL defines the user accounts or groups that own or have specific [permissions]({{< ref "/CORETutorials/Storage/Pools/Permissions" >}}) to the shared dataset.

...
Configure [SSH]({{< ref "/CORETutorials/SystemConfiguration/ConfiguringSSHConnections" >}}) and [automatic dataset snapshots]({{< ref "CreatingPeriodicSnapshotTasks" >}}) in TrueNAS before creating a remote replication task.

...
TrueNAS can adjust when and how [alerts]({{< ref "/CORETutorials/SystemConfiguration/CreatingAlerts" >}}) for S.M.A.R.T. are issued.
...
From the **[Shell]({{< ref "/CORETutorials/UsingShell" >}})**, use `smartctl` and the name of the drive: `smartctl -l selftest /dev/ada0`.
{{< /expand >}}
...
{{< expand "CLI" "v" >}}
To verify the schedule is saved, you can open the [shell]({{< ref "/CORETutorials/UsingShell" >}}) and enter `smartd -q showtests`.
{{< /expand >}}

## Service Options

You must [enable S.M.A.R.T. service]({{< ref "/CORETutorials/Services/ConfiguringSMART" >}}) to run automatic S.M.A.R.T. tests.

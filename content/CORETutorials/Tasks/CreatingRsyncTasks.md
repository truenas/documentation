...
The **Host** system needs an established [SSH connection]({{< relref "/CORETutorials/SystemConfiguration/ConfiguringSSHConnections.md" >}}) to the **Remote** for the rsync task.
...
The name in **User** must be identical to the [SSH Connection]({{< relref "/CORETutorials/SystemConfiguration/ConfiguringSSHConnections" >}}) **Username**.

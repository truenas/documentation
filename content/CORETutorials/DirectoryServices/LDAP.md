...
See [LDAP Screen]({{< ref "LDAPScreen" >}}) for information on basic and advanced option settings.

See [Kerberos]({{< ref "/CORETutorials/DirectoryServices/Kerberos" >}}) for more information on using Kerberos.

To configure LDAP certificate-based authentication for the LDAP provider to sign, see [Certificate Signing Requests]({{< ref "CreatingCertificates" >}}).

...
4. If the jail needs to access existing data, [edit the permissions]({{< relref "/CORETutorials/Storage/Pools/Permissions.md" >}}) of the pool or dataset so the user and group accounts have the desired read and write access.
...
5. If you are setting aside a new storage area for that jail or application, [create a dataset]({{< relref "/CORETutorials/Storage/Pools/Datasets.md" >}}).

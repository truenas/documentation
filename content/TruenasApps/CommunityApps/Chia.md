...
## First Steps
Before you install the application, you have the option to create the **config** and **plots** datasets for the Chia app storage volumes, or you can allow the TrueNAS to automatically create these storage volumes.
...
Application configuration settings are presented in several sections, each explained in [Understanding SCALE Chia Wizard Settings](#understanding-truenas-chia-wizard-settings) below.
...
{{< trueimage src="/images/Apps/ChiaChoosePodforShell.png" alt="Chia Choose Pod for Shell" id="Chia Choose Pod for Shell" >}}

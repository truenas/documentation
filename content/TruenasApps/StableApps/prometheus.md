...
Or before beginning app installation, [create the datasets]({{< ref "DatasetsSCALE" >}}) named **data** and **config** to use in the **Storage Configuration** section during installation.

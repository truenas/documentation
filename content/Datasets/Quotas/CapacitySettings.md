...
weight: 50
aliases:
 - /scale/scaleuireference/datasets/capacitysettingsscale/
 - /scale/scaleuireference/storage/datasets/capacitysettingsscale/
 - /scale/datasets/capacitysettings/
tags:
- quotas
- datasets
doctype: reference
...
The settings on the **Capacity Settings** screen are the same as those in the quota management section on the **[Add Dataset]({{< ref "/Datasets" >}}) > Advanced Options** screen.

...
Datasets, root, non-root parent, and child, or zvols with encryption include the **[Encryption]({{< ref "/Datasets" >}})** widget in the set of dataset widgets shown on the **Datasets** screen.
...
The [**Encryption Options** settings]({{< ref "/Datasets/ManagingDatasets#encryption-options-section" >}}) under **Advanced Options** on the **Add Dataset** screen configure encryption for that dataset.

...
The [**Encryption Options** settings]({{< ref "/Datasets/Datasets#encryption-options-section" >}}) under **Advanced Options** on the **Add Dataset** screen configure encryption for that dataset.

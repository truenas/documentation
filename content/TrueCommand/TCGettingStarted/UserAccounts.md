...
This requires that [system connections]({{< relref "/TrueCommand/TCGettingStarted/AddSystems.md#connecting-systems-to-truecommand" >}}) and/or system groups have already been configured in TrueCommand.

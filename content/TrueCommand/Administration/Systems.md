...
{{< expand "Edit" "v" >}}
Clicking <i class="material-icons" aria-hidden="true" title="Configure">edit</i>  **Edit**  opens a panel on the right of the screen that displays the system setting fields you can edit. After making your changes, click **SAVE CHANGES** to update the system with the new values entered. 

...
You can move an alert to the **RESOLVED** column by clikcing the **Resolve** <i class="material-icons" aria-hidden="true" title="Check">check</i> to the right of the delete icon.
...
Alerts generated by a monitored system display on both the **Systems** screen and the **Dashboard** as a number to the right of the system name.

![DashboardSystemAlerts](/images/TrueCommand/2.1/DashboardSystemAlerts.png "Dashboard System Alerts")

To view all alerts for a single system, from the **Dashboard** and click on a system name that have alerts indicated. That system's details screen displays.
...
To resolve an alert on the system detail screen, click on the **Resolve alert notice** <i class="material-icons" aria-hidden="true" title="Check">check</i> to the left of the comments icon.

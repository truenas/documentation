...
TrueCommand administrators and [team members]({{< relref "/TrueCommand/AdministrationUsers.md#configuring-teams" >}}) with the appropriate permissions can create new alert rules.

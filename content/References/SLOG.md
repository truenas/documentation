...
See the SLOG over-provisioning guide for [TrueNAS CORE](https://www.truenas.com/docs/core/13.0/coretutorials/storage/pools/slogoverprovision/) or [TrueNAS SCALE]({{< relref "/SCALE/SCALETutorials/Storage/Disks/SLOGOverprovisionSCALE.md" >}}) over-provisioning procedures.

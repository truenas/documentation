...
[TrueNAS provides for full Access Control List (ACL) compatibility]({{< ref "/SCALE/Datasets/Permissions/ConfiguringACLs" >}}) between Windows and Linux with NFSv4 ACLs on ZFS and eases the challenges of integrating Unix servers in Windows environments.

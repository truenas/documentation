...
* [**ZFS Datasets**]({{< ref "/SCALE/Datasets" >}}): similar to a conventional mounted filesystem.
...
* [**ZFS Pools**]({{< ref "/SCALE/Storage" >}}): filesystem container that is composed of one or more vdevs.
...
* [**ZFS zvols**]({{< ref "/SCALE/Datasets/Zvols/AddManageZvols" >}}): datasets that represent block devices.
...
* [**Fusion Pool**]({{< ref "/SCALE/Storage/Pools/CreatingFusionPools" >}}) (or metadata vdev): is a special class of vdev.
...
* [**ZFS Snapshots**]({{< ref "/SCALE/Datasets/Snapshots/CreatingSnapshots" >}}): read-only copy of a file system or volume.
...
* [**ZFS Scrub**]({{< ref "/SCALE/Storage/Pools/ManagePools" >}}): the process that ZFS uses to verify the data on disk.
  All of the data is read and checked against the computed checksums to verify that no corruption has occurred.

* [**ZFS Resilver**]({{< ref "/SCALE/Storage/Pools/ManagePools" >}}): process to reconstruct data on a disk when that disk has replaced a failed disk.

* [**ZFS Replication**]({{< ref "/SCALE/DataProtection/Replication" >}}): copying a ZFS dataset to another dataset.
...
* [**Cloud Sync**]({{< ref "/SCALE/DataProtection/CloudSyncTasks" >}}): TrueNAS sending, receiving, or synchronizing data with a Cloud Storage provider like Amazon S3, Google Cloud, or Microsoft Azure.

...
* [**ZFS Datasets**](https://www.truenas.com/docs/core/13.0/coretutorials/storage/pools/datasets/): similar to a conventional mounted filesystem.
...
* [**ZFS Pools**](https://www.truenas.com/docs/core/13.0/coretutorials/storage/pools/): filesystem container that is composed of one or more vdevs.
...
* [**ZFS zvols**](https://www.truenas.com/docs/core/13.0/coretutorials/storage/pools/zvols/): datasets that represent block devices.
...
* [**Fusion Pool**](https://www.truenas.com/docs/core/13.0/coretutorials/storage/pools/fusionpool/) (or metadata vdev): is a special class of vdev.
...
* [**ZFS Snapshots**](https://www.truenas.com/docs/core/13.0/coretutorials/storage/snapshots/): read-only copy of a file system or volume.
...
* [**ZFS Scrub**](https://www.truenas.com/docs/core/13.0/coretutorials/tasks/creatingscrubtasks/): the process that ZFS uses to verify the data on disk.
  All of the data is read and checked against the computed checksums to verify that no corruption has occurred.

* [**ZFS Resilver**](https://www.truenas.com/docs/core/13.0/coretutorials/tasks/usingresilverpriority/): process to reconstruct data on a disk when that disk has replaced a failed disk.

* [**ZFS Replication**]({{< relref "/SCALE/SCALETutorials/DataProtection/_index.md" >}}): copying a ZFS dataset to another dataset.
...
* [**Cloud Sync**](https://www.truenas.com/docs/core/13.0/coretutorials/tasks/creatingcloudsynctasks/): TrueNAS sending, receiving, or synchronizing data with a Cloud Storage provider like Amazon S3, Google Cloud, or Microsoft Azure.

...
Before adding iSCSI shares, make sure you have already created a [zvol]({{< ref "AddManageZvols" >}}) or a [dataset]({{< ref "/SCALE/Datasets/Datasets" >}}) with at least one file to share. Do not use capital letters or spaces in the names or path.

...
* **Audit Logs** opens the [**Audit** screen]({{< ref "/SystemSettings/Audit/Auditing" >}}) with a predefined filter applied to show the SMB logs.
...
For detailed information about group validation and troubleshooting disabled shares, see [Configuring SMB Auditing]({{< relref "/SystemSettings/Audit/Auditing#configuring-smb-auditing" >}}).
...
See [Permissions]({{< ref "/Datasets/Permissions" >}}) for more information on configuring permissions.

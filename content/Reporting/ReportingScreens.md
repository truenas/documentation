...
The UPS service must be [configured]({{< ref "UPSServices" >}}) with a compatible Uninterruptible Power Supply (UPS) device.
...
See [Adding a Reporting Exporter]({{< ref "ConfigReports#adding-a-reporting-exporter" >}}) for guidance with configuring a Graphite exporter on TrueNAS.

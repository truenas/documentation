...
weight: 10
aliases:
 - /scaletutorials/dataprotection/cloudsynctasks/cloudsynctaskgoogledrive/
 - /dataprotection/cloudsynctasks/cloud-sync-tasks/cloudsynctaskgoogledrive/
tags:
 - cloud
 - backup
keywords:
...
See **Using Scripting and Environment Variables** for more information on [environment variables]({{< ref "/DataProtection/CloudSyncTasks" >}}).

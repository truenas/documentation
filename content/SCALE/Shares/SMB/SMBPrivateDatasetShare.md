...
We recommend using the [**Add Dataset** screen]({{< ref "/SCALE/Datasets/Datasets" >}}) to access the dataset advanced setting options when you want to customize the dataset, and using the **Add SMB** screen to create and customize an SMB share with presets and advanced options.
...
Next, [set up the Active Directory]({{< ref "/SCALE/Credentials/DirectoryServices/ConfigAD" >}}) that you want to share resources with over your network.

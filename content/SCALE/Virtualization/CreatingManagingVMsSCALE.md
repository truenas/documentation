...
Before creating a virtual machine, you need an installer <file>.iso</file> or image file for the OS you intend to install, and a [storage pool]({{< relref "PoolsSCALE.md" >}}) available for both the virtual disk and OS install file.

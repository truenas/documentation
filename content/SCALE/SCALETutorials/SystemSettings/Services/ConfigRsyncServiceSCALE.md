...
description: "Provides information on configuring an rsync module and TCP port to use as an alternative to SSH when communicating with a TrueNAS as a remote rsync server."
weight: 35
alias: 
tags:
 - scalersync

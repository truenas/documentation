...
Before configuring TrueNAS as either an OpenVPN server or client, you need an existing public key infrastructure (PKI) with [Certificates and Certificate Authorities]({{< relref "/SCALE/SCALEUIReference/Credentials/Certificates/CertificatesSCALE.md" >}}) created in or imported to TrueNAS.

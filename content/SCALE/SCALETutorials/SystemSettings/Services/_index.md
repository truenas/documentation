...
Documented services related to data sharing or automated tasks are in their respective [Shares]({{< relref "/SCALE/SCALEUIReference/Shares" >}}) and [Tasks]({{< relref "/SCALE/SCALEUIReference/DataProtection" >}}) articles.

...
4. Specify the source and destination paths. Destination paths allow adding /*name* to the end of the path to create a new dataset in that location.
   ...
   If the file browser shows a connection error after selecting the correct **SSH Connection**, you might need to log in to the remote system and [configure it to allow SSH connections]({{< ref "/SCALE/SCALEUIReference/Credentials/BackupCredentials" >}}).

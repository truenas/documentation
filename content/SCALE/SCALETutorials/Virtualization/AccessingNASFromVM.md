...
* If you have only one physical interface, you must create a bridge interface for the VM. This approach ensures connectivity and flexibility, especially for high availability (HA) setups.

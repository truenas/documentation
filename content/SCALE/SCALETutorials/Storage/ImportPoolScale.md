...
The 24.04 [Preparing to Migrate](https://www.truenas.com/docs/scale/24.04/gettingstarted/migrate/migrateprep/) article provides information on what you can and cannot migrate and a checklist of actions to take before migrating from CORE with GELI-encrypted pools to SCALE.
{{< /expand >}}

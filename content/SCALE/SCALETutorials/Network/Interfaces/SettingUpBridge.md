...
A bridge can also be used to allow a VM configured on TrueNAS to communicate with the host system. See [Accessing NAS From a VM]({{< relref "ContainerNASBridge.md" >}}) for more information.

...
For information on configuring IPv6 addresses, see [Configuring IPv6]({{< relref "ConfigureIPv6" >}}).
...
From the [Console Setup menu]({{< relref "ConsoleSetupMenuSCALE" >}}), select option 1 to configure network settings or add alias IP addresses.

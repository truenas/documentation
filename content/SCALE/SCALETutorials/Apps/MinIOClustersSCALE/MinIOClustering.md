...
description: "This article provides configuration instructions using the **MinIO Offical Charts** application widget, it includes instructions setting up a distributed cluster configuration."
weight: 20

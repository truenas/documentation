...
description: "This article provides instructions on adding a WebDAV share, starting or stopping the WebDAV service, and connecting with a web browser."
weight: 40
aliases: 
tags:
 - scalewebdav
...
This warning does not show if the **Change User & Group Ownership** option is cleared.
In this situation, you must manually set shared file ownership to the webdav or **www** user and group accounts.

By default, the new WebDAV share is immediately active.
To create the share but not immediately activate it, clear **Enable**.
...
To enable or disable the WebDAV service, go to **System Settings > Services** and clic the **WebDAV** toggle to **Stopped**.

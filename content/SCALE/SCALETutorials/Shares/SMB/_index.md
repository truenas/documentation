...
3. Select a share type on the **Purpose** dropdown list.
   ...
   Select **MacOS Media Share** (available in TrueNAS 25.10.1 and later) to create a share optimized for Apple Media & Entertainment workflows.
   The SMB share is configured with Apple name mangling and requires Apple SMB2/3 protocol extensions for compatibility with Final Cut Pro, Logic Pro, and other professional media applications.

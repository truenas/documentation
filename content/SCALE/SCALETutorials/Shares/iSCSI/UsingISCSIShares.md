...
This section describes preparing your system to start the iSCSI service, log in to the share and obtain the basename and target TrueNAS configured. It provides information on partitioning the iSCSI disk, making a file system for the share, mounting it, and sharing data.

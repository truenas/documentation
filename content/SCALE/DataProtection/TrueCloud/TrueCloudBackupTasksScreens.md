...
The **TrueCloud Backup Tasks** card on the **Data Protection** screen shows configured TrueCloud tasks, and provides access to configuration screens to add or schedule recurring transfers between TrueNAS and a cloud storage provider account like Storj iX.
...
## TrueCloud Backup Tasks Card

The **TrueCloud Backup Tasks** card shows a list of tasks configured on the system.

{{< trueimage src="/images/SCALE/DataProtection/TrueCloudTaskSuccess.png" alt="TrueCloud Backup Tasks Card" id="TrueCloud Backup Tasks Card" >}}

The card shows **No records have been added yet** until a TrueCloud task is added.

The card header opens the [**TrueCloud Backup Tasks**](#truecloud-backup-tasks-screen) screen that lists all TrueCloud backup tasks configured on the system.

**Add** on the card and the **TrueCloud Backup Tasks** screen opens the **[Add TrueCloud Backup Task Screen](#add-truecloud-backup-task-screen)**.

Each task on the card includes a vertical ellipses <span class="material-icons">more_vert</span> icon that opens a dropdown menu with four options for various functions:
...
The **TrueCloud Backup Tasks <i class="material-icons" aria-hidden="true" title="Open In New">open_in_new</i>** on the card title or **<i class="material-icons" aria-hidden="true" title="View Details">visibility</i> View Details** on a task opens the **TrueCloud Backup Tasks** screen.
...
Task options perform the same functions as the icons on the card:
...
### Snapshots Card
The **Snapshots** card lists existing TrueCloud snapshots for the selected backup task.
It contains options to restore from or delete an existing snapshot.

{{< trueimage src="/images/SCALE/DataProtection/TrueCloudSnapshots.png" alt="Snapshots Card" id="Snapshots Card" >}}
...
#### Remote Settings {id="truecloud_restore_remote"}
...
#### Local Settings {id="truecloud_restore_local"}
...
### Local Settings  {id="truecloud_add_local"}
...
### Remote Settings  {id="truecloud_add_remote"}
...
### Task Settings  {id="truecloud_add_task"}
...
### Control Settings  {id="truecloud_add_control"}
...
| **Enabled** | Select to enable the TrueCloud task. Leave clear to disable the task without deleting it and keep the configuration available without allowing the specified schedule to run the task. The toggle in the **Enable** column on the **TrueCloud Backup Tasks** card enables/disables the task. |
{{< /truetable >}}
...
### Advanced Options Settings  {id="truecloud_add_advanced"}
...
### Advanced Remote Options  {id="truecloud_add_advanced-remote"}

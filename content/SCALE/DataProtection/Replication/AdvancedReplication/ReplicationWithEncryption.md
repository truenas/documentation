...
weight: 10
aliases:
 - /scale/scaletutorials/dataprotection/replication/advancedreplication/replicationwithencryptionscale/
...
Configure the remote replication as described in the [Creating a Remote Replication Task]({{< ref "RemoteReplication" >}}).

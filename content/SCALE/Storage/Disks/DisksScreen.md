...
| **Advanced Power Management (APM)** | Sets the APM level that controls power management behavior when drives are idle, not maximum performance capabilities. When drives are actively accessed, they operate at full performance regardless of the APM setting. Lower-numbered levels prioritize power savings during idle periods, while higher levels prioritize quick response times. Power management profile options: <ul><li>**Disabled** (the default setting)</li><li>**Level 1 - Minimum power usage with Standby (spindown)**</li><li>**Level 64 - Intermediate power usage with Standby**</li><li>**Level 127 - Maximum power usage with Standby**</li><li>**Level 128 - Minimum power usage without Standby (no spindown)**</li><li>**Level 192 - Intermediate power usage without Standby**</li><li>**Level 254 - Maximum performance, maximum power usage**</li></ul> |
{{< /truetable >}}

...
{{< enterprise >}}
Enterprise systems licensed for SED and with SED drives, see a message about SED encryption and that indicates only SED-capable disks are available for selection when a pool with SED encryption is selected.

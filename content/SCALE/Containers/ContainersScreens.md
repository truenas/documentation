...
| Setting | Description |
|-----------|-------------|
| **Bridge** | Specifies the network bridge.  **Automatic** uses the default network bridge for communication between containers and the TrueNAS host. The dropdown list option shows existing bridges. See [Accessing NAS from VMs and Containers]({{< ref "/SCALE/Network/ContainerNASBridge" >}}) for more information. |
...
See [Accessing NAS from VMs and Containers]({{< ref "/SCALE/Network/ContainerNASBridge" >}}) for more information.

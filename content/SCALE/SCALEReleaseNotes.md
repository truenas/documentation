...
|---------|-----|---------|------------|-------------|
| 2.02.4  |  | Upgrading from 22.02.4 to 22.12-BETA.1 is unavailable. | Workaround is to either upgrade from a version before22.01.4 or to upgrade to 22.12-BETA.2. | 22.12-BETA.2 |

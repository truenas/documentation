...
Therefore, capacity-oriented TrueNAS and certain [TrueNAS R-Series](https://www.freenas.org/freenas-certified-servers/) systems ship with [Western Digital UltraStar](https://www.westerndigital.com/products/data-center-platforms) NL-SAS disks thanks to the all-around perfect balance of capacity, reliability, performance, and flexibility that NL-SAS drives offer.
{{< /tab >}}
{{< tab "SAS Disks" >}}

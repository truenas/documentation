...
WD Red™ Plus NAS drives (non-SMR) are designed for use in systems with up to eight hard drives, up to 16 drives in the case of the [WD Red™ Pro](https://shop.westerndigital.com/products/internal-drives/wd-red-plus-sata-2-5-hdd#WD10JFCX) drives, and [WD UltraStar™](https://www.westerndigital.com/products/data-center-platforms) drives for systems beyond 16 drives.
...
{{< /tab >}}
{{< tab "USB Hard Disks" >}}
We recommend users avoid USB-connected hard disks for primary storage with TrueNAS, but they can be used for very basic backups in a pinch.
...
SLOG devices **must** have power protection.
...
{{< /tab >}}
{{< tab "Boot Devices" >}}
It was once very popular to boot FreeNAS systems from 8 GB or larger USB flash drives, but with the wide variance in USB drive quality and the increased drive writes done to the boot pool by modern TrueNAS versions, we advise looking at other options.
For this reason, all TrueNAS Mini and R-Series systems ship with either M.2 drives or SATA DOMs.
...
{{< hint info >}}
TrueNAS SCALE is not currently net optimized for boot media like SATA doms.
{{< /hint >}}
...
* Plugins and have specific application RAM requirements
...
[TrueNAS Mini](https://www.truenas.com/truenas-mini/) and [TrueNAS R-Series](https://www.ixsystems.com/freenas-certified-servers/) systems are tailor made for TrueNAS and take each of these best practices into consideration for the very best TrueNAS experience.

...
More details are available from [Software Releases]({{< relref "/TrueNASUpgrades" >}}).
...
See the [Migration articles]({{< relref "/SCALE/GettingStarted/Migrate" >}}) for cautions and notes about differences between each software and the migration process.

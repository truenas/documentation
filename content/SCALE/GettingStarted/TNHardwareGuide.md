...
<div style="display: none;" id="storage-solutions-tab-content-source">
  <div data-tab-id="hybris-storage-and-flash-cache" data-tab-label="Hybrid Storage & Flash Cache (SLOG/ZIL/L2ARC)">
...
<script>
document.addEventListener('DOMContentLoaded', function() {
    initializeHugoTabs('storage-solutions-tab-content-source', 'storage-solutions-tabs-container', 'hybris-storage-and-flash-cache');
});
</script>

...
See [Software Releases](https://docs.truenas.com/software-status/#upgrade-paths) for currently recommended update paths to make sure you download and migrate to and from the correct TrueNAS versions.

...
1. Upgrade your system to either the latest 13.0 or 13.3 release.
   TrueNAS Enterprise-licensed (or community systems that have not switched to 13.3) systems on 12.0x or earlier should upgrade to the latest 13.0 release (e.g. 13.0-U6.2 or newer) before migration.

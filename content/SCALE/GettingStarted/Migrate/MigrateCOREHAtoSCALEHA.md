...
Customers with CORE Enterprise HA systems that want to upgrade or migrate to SCALE Enterprise HA, you can only do a clean install of SCALE and import your pools. You cannot migrate the CORE HA system to a SCALE HA system.

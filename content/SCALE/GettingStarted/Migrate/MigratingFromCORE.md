...
Uploading the CORE config file deletes the **truenas_admn** user account created during a clean install and therefore requires you to [recreate it](#recreating-the-admin-user-account).

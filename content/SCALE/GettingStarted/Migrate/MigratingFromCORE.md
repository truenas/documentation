...
VM storage and its basic configuration is transferred over during a migration. You will need to double-check the VM configuration and the network interface settings specifically before starting the VM.

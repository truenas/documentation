...
| **Script** | Select the script. Scripts run using [dash(1)](https://manpages.debian.org/testing/dash/sh.1.en.html "dash(1) Page") by default, or under the interpreter named in the script's shebang line (for example, `#!/bin/bash`). |

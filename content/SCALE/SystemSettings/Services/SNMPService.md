...
See [SNMP Service Screen]({{< ref "SNMPServiceScreen" >}}) for setting information.

Port **UDP 161** listens for SNMP requests when starting the SNMP service.

## Management Information Bases (MIBs)

Click to view or download a static copy of the <a href="https://www.truenas.com/docs/files/truenas-mib-halfmoon.txt">TrueNAS 26 (Halfmoon) MIB</a> file.

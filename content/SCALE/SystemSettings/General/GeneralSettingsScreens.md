...
| **Security** | Sets the security option to what is selected on the dropdown list. Options are:<ul><li>**Plain (No Encryption)**</li><li>**SSL (Implicit TLS)**</li><li>**TLS (STARTTLS)**</li></ul> For more information on types, see [email encryption](https://www.fastmail.com/help/technical/ssltlsstarttls.html). |

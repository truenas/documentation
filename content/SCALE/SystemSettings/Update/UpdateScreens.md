...
See the [TrueNAS Software Status](https://www.truenas.com/docs/softwarestatus/) page for current version recommendations by user type, and the [Software Development Life Cycle]({{< ref "SoftwareDevelopmentLifeCycle" >}}) for details on TrueNAS release stages.

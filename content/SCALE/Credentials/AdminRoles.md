...
To use two-factor authentication with an administrator account, configure and enable SSH service to allow SSH access, then [configure two-factor authentication]({{< ref "ManageGlobal2FA" >}}).

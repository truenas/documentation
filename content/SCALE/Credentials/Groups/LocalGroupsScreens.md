...
aliases:
 ...
 - /scale/scaleuireference/credentials/localgroupsscreens/
...
| **SMB Group** | Select to make the group available for permissions editors over [SMB protocol]({{< ref "/SCALE/Shares" >}}) (and the share ACL editor). Not used for SMB authentication or determining the user session token or internal permissions checks. |
{{< /truetable >}}

...
For information on how to add a DNS authenticator in TrueNAS, see [Adding ACME DNS Authenticators]({{< relref "AddACME" >}}).
{{< /hint >}}
...
{{< hint type=info >}}
You must [configure a DNS authenticator]({{< relref "AddACME" >}}) to create an ACME certificate!

...
weight: 35
aliases:
 - /scale/scaleuireference/datasets/snapshotsscreens/
...
Access to the **Snapshots** screen is available using the **Manage Snapshots** link on the **Data Protection** widget on the **Datasets** screen and by clicking **Snapshots** on the **[Periodic Snapshot Tasks]({{< ref "PeriodicSnapshotTasksScreens" >}})** widget on the **Data Protection** screen.

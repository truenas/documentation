...
See [Adding and Managing Datasets]({{< ref "/SCALE/Datasets/Datasets" >}}) for more information.

To manage the dataset overall capacity, use **Edit** on the **Dataset Space Management** widget to open the **[Capacity Settings]({{< ref "CapacitySettings" >}})** screen.

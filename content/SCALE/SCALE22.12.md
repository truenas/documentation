...
|---------|-----|---------|------------|-------------|
| 22.12.1 | <a href="https://ixsystems.atlassian.net/browse/NAS-120432" target="_blank">NAS-120368</a> | Replication tasks from 22.12.0 error out in 22.12.1 | This issue is still under investigation. If a replication task is critical for usability, wait to update from 22.12.0 to 22.12.1 until this has been investigated and a workaround determined. | TBD |

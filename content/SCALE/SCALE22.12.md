...
|---------|-----|---------|------------|-------------|
| 22.12-BETA.2 | <a href="https://ixsystems.atlassian.net/browse/NAS-118632" target="_blank">NAS-118632</a> | Traceback received during pool creation | When attempting to create a pool using 22.12-BETA.2 to test drive replacement, received a traceback error. | Targeted 22.12-RC.1 |

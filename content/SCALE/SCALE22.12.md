...
|---------|-----|---------|------------|-------------|
| 22.12-BETA.2 | NAS-118703 | <a href="https://ixsystems.atlassian.net/browse/NAS-118703" target="_blank">NAS-118703</a> | Traceback received during pool creation. | Users might experience a traceback error when creating a pool. This is a minor error that stems from moving the system dataset to a new pool. | Unknown |

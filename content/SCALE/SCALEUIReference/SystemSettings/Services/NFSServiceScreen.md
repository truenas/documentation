...
| **Specify number of threads manually** | Becomes visible and editable after deselecting **Calculate number of threads dynamically**. Enter an optimal number of threads used by the kernel NFS server. |
{{< /truetable >}}

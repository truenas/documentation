...
| **Log in as Admin with Password** | Allows root (admin) logins. Root logins are discouraged! Select to allow the admin account to log into TrueNAS with a password. You must set and enable a password for the admin account. |

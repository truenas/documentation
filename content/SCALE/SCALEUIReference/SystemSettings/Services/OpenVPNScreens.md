...
{{< trueimage src="/images/SCALE/OpenVPNClient.png" alt="OpenVPN Client Options" id="OpenVPN Client Options" >}}
...
{{< trueimage src="/images/SCALE/OpenVPNServer.png" alt="OpenVPN Server Options" id="OpenVPN Server Options" >}}

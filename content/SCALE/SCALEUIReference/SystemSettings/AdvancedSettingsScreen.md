...
{{< trueimage src="/images/SCALE/22.12/AdvancedSystemSettingsConsoleWidget.png" alt="Console Widget" id="2: Console Widget" >}}
...
{{< trueimage src="/images/SCALE/22.12/ConsoleConfigScreen.png" alt="Console Config Screen" id="3: Console Config Screen" >}}
...
{{< trueimage src="/images/SCALE/23.10/SystemSettingsAdvancedKernel.png" alt="Kernel Widget" id="6: Kernel Widget" >}}
...
{{< trueimage src="/images/SCALE/23.10/AdvancedSystemInitShutdownScriptWidget.png" alt="Init/Shutdown Scripts Widget" id="9: Init/Shutdown Scripts Widget" >}}
...
{{< trueimage src="/images/SCALE/22.12/AddSysctlConfigScreen.png" alt="Sysctl Config Screen" id="12: Sysctl Config Screen" >}}
...
{{< trueimage src="/images/SCALE/22.12/SystemStorageConfigScreen.png" alt="System Dataset Pool Config Screen" id="14: System Dataset Pool Config Screen" >}}
...
{{< trueimage src="/images/SCALE/23.10/AdvancedSystemSettingsSessionsWidget.png" alt="Sessions Widget" id="17: Sessions Widget" >}}
...
{{< trueimage src="/images/SCALE/23.10/TimeoutDialog.png" alt="Logout Dialog" id="18: Logout Dialog" >}}
...
{{< expand "" "v" >}}
{{< trueimage src="/images/SCALE/23.10/TokenSettingsScreen.png" alt="Token Settings Screen" id="19: Token Settings Screen" >}}

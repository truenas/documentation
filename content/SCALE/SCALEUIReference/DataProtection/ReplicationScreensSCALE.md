...
| **Include Dataset Properties** | Select to include dataset properties with the replicated snapshots. This enables users to see ZFS dataset properties, which can be futher reviewed at the [ZFS manpages](https://linux.die.net/man/8/zfs).|

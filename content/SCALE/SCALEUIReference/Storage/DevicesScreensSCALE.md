...
To remove a drive from the VDEV, select the drive, then select **Detach** on the **[ZFS Info](#zfs-info-card)** card to remove the drive from the VDEV (pool).
...
{{< trueimage src="/images/SCALE/Storage/VDEVDiskCards.png" alt="VDEV Screen Disk Cards" id="Vdev Screen Disk Cards" >}}

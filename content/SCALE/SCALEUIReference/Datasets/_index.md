...
Use the **Disconnect/Export** option on the **[Storage Dashboard]({{< ref "/SCALE/SCALEUIReference/Storage" >}})** screen to deleate a root datset.
...
| Apps | [Manage Apps Settings]({{< ref "/SCALE/SCALEUIReference/Apps" >}}) | Shows apps (Docker) is using the dataset. Select the option to **Choose Pool** from the **Settings** dropdown list on the **Applications** screen. |
...
Encryption setting options show on the **Advanced Options** screen for the **Add Dataset** screen but not on the **Edit Dataset** screen.

...
| **Export Recycle Bin** | Select to enable. Deleted files from the same dataset move to a **Recycle Bin** in that dataset and do not take any additional space. Deleting files over NFS removes the files permanently. |

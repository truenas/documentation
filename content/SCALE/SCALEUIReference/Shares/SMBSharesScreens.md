...
| **Hosts Allow** | Enter a list of allowed IP addresses or networks. Separate entries by pressing <kbd>Enter</kbd>. For a more detailed description with examples click [here](https://www.samba.org/samba/docs/current/man-html/smb.conf.5.html#HOSTSALLOW).

...
{{< /hint >}}
Many of the settings in the **Add Certificate** wizard are the same as those in the **[Add CA]({{< relref "CAScreensSCALE" >}})** and **[Add Certificate Signing Request]({{< relref "CSRScreensSCALE" >}})** wizards.

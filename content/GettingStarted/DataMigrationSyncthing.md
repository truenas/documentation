...
This allows users to migrate data from a third-party NAS solution onto TrueNAS SCALE using the [Syncthing Enterprise application]({{< relref "/scaletutorials/apps/enterpriseapps/syncthing.md" >}}).

...
2. Download the [TrueNAS manual update file](https://www.truenas.com/download-truenas-scale/).
   See [Software Releases](https://docs.truenas.com/software-status/#upgrade-paths) for current recommended update paths to make sure you download and migrate to the correct version.
...
Go to **System > Advanced Settings** and [upload the system config file]({{< relref "/SCALE/SystemSettings/Advanced/ManageSysConfig.md#uploading-the-file" >}}).

...
See [Software Releases](https://www.truenas.com/docs/softwarereleases/#upgrade-paths) for currently recommended update paths to make sure you download and migrate to and from the correct TrueNAS versions.

...
* sendmail is removed for security reasons ([NAS-133174](https://ixsystems.atlassian.net/browse/NAS-133174)). Users previously using sendmail as part of their custom scripting should use `exim` instead.

...
* Fix issue with zpl_get_name ([NAS-132930](https://ixsystems.atlassian.net/browse/NAS-132930)). This can improve performance in some specific NFS workloads (see the upstream [OpenZFS pull request](https://github.com/openzfs/zfs/pull/16833/files)).

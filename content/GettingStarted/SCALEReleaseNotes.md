...
* Network UPS Tools (NUT) service takes 100% CPU on 1 thread when power is cut to the UPS [NAS-130175](https://ixsystems.atlassian.net/browse/NAS-130175).
  This issue is resolved in a version 2.8.1 of the related service, which will be made available in a future TrueNAS release when the [updated NUT version](https://tracker.debian.org/pkg/nut) is moved into upstream stable Debian repositories.

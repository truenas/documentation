...
A simple configuration is beyond the scope of this getting started guide, but detailed articles are available in in the [iSCSI Sharing topic]({{< ref "iSCSIShare" >}})
{{< /tab >}}
{{< /tabs >}}

With simple sharing done, TrueNAS is now installed, accessible, and capable to receive or share data over your network.
Now it's time to protect the TrueNAS storage by setting up [data backups]({{< ref "DataBackups" >}})

...
The SHA256 checksum file for each TrueNAS release is published alongside the <kbd>.iso</kbd> file on the [TrueNAS Download page](https://www.truenas.com/download/) and in the [TrueNAS software CDN](https://iso.sys.truenas.net/).
{{< expand "Click here for the verification process." "v" >}}

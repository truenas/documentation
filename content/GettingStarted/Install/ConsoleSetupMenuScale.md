...
* **6) Open TrueNAS CLI Shell**
  ...
  Use to start a shell for running TrueNAS commands, or use the SCALE UI **[System Settings > Shell]({{< ref "UseScaleShell" >}})**.
...
* [Completing network configuration] ({{< ref "/SCALETutorials/Network/" >}}) if not already set up using the Console Setup menu.

...
After installing and completing your system configuration, [create a boot environment]({{< relref "ManageBootEnvironSCALE" >}}) to use as a restore point.
...
* [Rsync tasks]({{< relref "RsyncTasksSCALE" >}})
...
See [Adding Cloud Credentials]({{< relref "/SCALETutorials/Credentials/BackupCredentials/AddCloudCredentials" >}}) for information on connecting TrueNAS to other cloud storage providers.

...
description: "Information on configuring TrueNAS SCALE after installation."
...
After completing the installation process, you can either use the [Console setup menu]({{< ref "ConsoleSetupMenuSCALE" >}}) to reconfigure the primary network interface with a static IP address or use the SCALE UI to make network changes and complete the initial configuration.

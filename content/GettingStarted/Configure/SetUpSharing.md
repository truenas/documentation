...
For more information on TrueNAS SCALE shares, see the [Shares]({{< relref "/SCALETutorials/Shares/" >}}) tutorials.
...
For more information on adding SMB shares, see [Adding SMB Shares]({{< relref "/SCALETutorials/Shares/" >}}).
...
A simple configuration is beyond the scope of this getting started guide, but detailed articles are [available in the SCALE Tutorials section]({{< relref "/SCALETutorials/Shares/iSCSI/" >}}).

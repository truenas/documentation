...
For more information on TrueNAS shares, see the [Shares]({{< ref "/SCALETutorials/Shares" >}}) tutorials.
...
For more detailed information on adding SMB shares, see [Adding SMB Shares]({{< ref "/SCALETutorials/Shares" >}}).
...
A simple configuration is beyond the scope of this getting started guide, but detailed articles are [available in the Tutorials section]({{< ref "/SCALETutorials/Shares/iSCSI" >}}).

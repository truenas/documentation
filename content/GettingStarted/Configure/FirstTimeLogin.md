...
To access the web interface using an IP address, either use the DHCP-assigned IP address displayed at the top of the Console Setup menu after installing TrueNAS or use the static IP address you assigned using the [Console Setup menu]({{< ref "ConsoleSetupMenuScale.md" >}}).
...
To [customize the dashboard ]({{< ref "/Dashboard" >}}), click **Configure** to put the **Dashboard** into configuration mode.

...
weight: 30
aliases:
 - /scaletutorials/systemsettings/general/settingupsystememail/
...
{{< hint type=note >}}
TrueNAS mails [Scrub Task]({{< ref "ManagePools" >}}) issues separately to the address configured in those services.
{{< /hint >}}

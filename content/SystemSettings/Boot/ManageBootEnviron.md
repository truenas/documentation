...
weight: 20
aliases:
 - /scaletutorials/systemsettings/managebootenvironscale/
 - /systemsettings/bootenvironment/
tags:
 - boot
 - settings
keywords:
...
Storage backups must be handled through the [ZFS snapshot]({{< ref "AddingPeriodicSnapshotTasks" >}}) feature or other [backup options]({{< ref "/DataProtection" >}}).

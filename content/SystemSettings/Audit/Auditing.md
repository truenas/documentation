...
weight: 20
aliases:
 - /scaletutorials/systemsettings/auditingscale/
tags:
 - auditing
 - system
 - stig
...
Generated every time a user attempts to open a web shell, for both successful and denied attempts.
...
Generated when an authenticated web shell session disconnects.
...
To configure Audit storage and retention settings, click **Audit Settings** on the **Audit** screen or go to **System > Advanced Settings**, then click **Configure** on the [**Audit**]({{< ref "/SystemSettings/Advanced/AdvancedSettingsScreen#audit-widget" >}}) widget.

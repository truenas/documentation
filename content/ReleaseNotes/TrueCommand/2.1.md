      ...
      <table width="100%">
        ...
        <tbody>
          <tr>
            ...
            <td>Deleting the last volume of a cluster TSP does not allow creating a new TSP with different nodes. This is an issue with the TrueNAS SCALE gluster implementation that will be fixed in the next SCALE release.</td>
          </tr>
        </tbody>
      </table>
    </body>

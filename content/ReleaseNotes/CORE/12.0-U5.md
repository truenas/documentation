...
For those with FreeNAS installed on your system, we recommend [upgrading](https://www.truenas.com/docs/core/system/update/majorupgrade/) to [FreeNAS 11.3-U5](https://www.freenas.org/download-freenas-release/) first and then upgrading to TrueNAS 12.0-U5 with a single click to retain roll-back options.  While it is an easy web update, we do recommend waiting to update your system’s zpool feature flags until you are finished validating your performance and functionality.

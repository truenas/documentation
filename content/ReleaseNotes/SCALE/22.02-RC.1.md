    	...
    	<body>
        	<table width="100%">
            	<thead><tr><th>Key</th><th>Summary</th><th>Workaround</th></tr></thead>
               	<tbody>  
				<tr><td></td><td>ZFS feature flag has been removed in this release.</td><td>See **ZFS Feature Flag Removal** below for more information.</td></tr>
...
{{< expand "ZFS Feature Flag Removal" "v" >}}
...
`debian-testing ➜  zfs git:(truenas/zfs-2.1-release) sudo zfs set xattr_compat=all p0` </br>
`debian-testing ➜  zfs git:(truenas/zfs-2.1-release) zpool get feature@xattr_compat p0`
...
Please keep in mind these are simplified, contrived examples.  If you aren't sure of how to replicate your pool, seek help on the TrueNAS forums.

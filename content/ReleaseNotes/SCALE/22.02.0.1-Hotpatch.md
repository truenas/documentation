...
The 22.02.0.1 security hotpatch implements security measures in response to [Red Hat CVE-2022-0847](https://access.redhat.com/security/cve/cve-2022-0847) announcement concerning a critical vulnerability was found in the Linux kernal. In response iXsystems is releasing this security patch. Refer to [xxx](xxx) for more information.

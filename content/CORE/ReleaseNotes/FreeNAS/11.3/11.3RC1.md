...
After an iocage dataset has been destroyed, it will need to be re-created with the CLI command iocage activate && iocage list before using jails and plugins again. For additional details please refer to [NAS-104254](https://jira.ixsystems.com/browse/NAS-104254).

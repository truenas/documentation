---
title: "SNMP Screen"
description: "Use the SNMP screen to configure Simple Network Management Protocol (SNMP) on your TrueNAS."
weight: 120
...
SNMP is an Internet Standard protocol used to gather and sort data about managed devices on IP networks, such as LANs and WANs. Use the **SNMP** screen to configure SNMP service on your TrueNAS.
...
**SAVE** activates after all required fields are populated with appropriate values. Click **SAVE** to save settings. 

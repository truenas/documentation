...
Configure [SSH]({{< relref "ConfiguringSSHConnections.md" >}}) and [automatic dataset snapshots]({{< relref "PeriodicSnapshotTasks.md" >}}) in TrueNAS before creating a remote replication task.

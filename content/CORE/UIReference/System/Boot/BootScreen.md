...
| Keep | Indicates whether or not TrueNAS deletes this boot environment when a [system update]({{< relref "/CORE/UIReference/System/Update/_index.md#truenas-core" >}}) does not have enough space to proceed. |
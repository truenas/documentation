...
The *Target* [Reporting]({{< relref "/CORE/UIReference/Administration/Reporting.md" >}}) tab provides Fibre Channel port bandwidth graphs.
{{< /hint >}}
{{< /tab >}}
{{< tab "Extents" >}}
*Add* a new extent.
...
After a virtual port has been associated with a target, it is added to the *Target* tab of [Reporting]({{< relref "/CORE/UIReference/Administration/Reporting.md" >}}) where its bandwidth usage can be viewed.

...
To include the snapshot in [replication tasks]({{< relref "/CORE/UIReference/Tasks/ReplicationTasks/_index.md" >}}) choose a proper naming schema. The **Naming Schema** dropdown list populates with schemas already created from periodic snapshot tasks.

...
Configure [SSH]({{< relref "/CORE/CORETutorials/Services/ConfiguringSSHConnections.md" >}}) and [automatic dataset snapshots]({{< relref "/CORE/CORETutorials/Tasks/PeriodicSnapshotTasks.md" >}}) in TrueNAS before creating a remote replication task.

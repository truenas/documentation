...
| 13.0-U5 | [NAS-122053](https://ixsystems.atlassian.net/browse/NAS-122053) | Mini E and E+, and IMMI Freeze after Reinserting Disk | After removing and replacing a drive, the View Enclosure screen freezes, and clearing cache or screen refresh the screen does not display the View Enclosure screen. IPMI console freezes after attempting to query disk sizes and won't accept inputs. | TBD |

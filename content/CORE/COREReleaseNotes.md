...
|---------|-----|---------|------------|-------------|
| 13.0-U3 |  | UI Does not show the correct status on HA systems | There is a known UI caching issue that impacts the status of failover in HA systems. The workaround is to clear the cache after failing over or making any UI changes to update the UI screens to show the correct status of the two nodes. | Targeted 13.0-U4 |

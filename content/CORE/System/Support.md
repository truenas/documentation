...
![JiraSuggestionVote](/images/JiraSuggestionVote.jpeg "Voting for a Suggestion")

To suggest a new feature, go to https://jira.ixsystems.com/projects/NAS/, log in to your Jira account, and click *Create*.

![JiraSuggestionCreate](/images/JiraSuggestionCreate.png "Creating a new Suggestion")

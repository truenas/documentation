...
To increase share security, configure allowed host names or IP addresses for [SMB shares]({{< relref "/scale/scaletutorials/shares/smb/#configuring-share-advanced-options-settings" >}}) or [NFS shares]({{< relref "/SCALE/SCALETutorials/Shares/AddingNFSShares/#adding-nfs-share-networks-and-hosts" >}}).

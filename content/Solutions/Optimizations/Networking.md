...
See [Setting Up Static IPs]({{< ref "/SCALE/Network/Interfaces" >}}) for more information.
...
See [Managing Interfaces]({{< ref "/SCALE/Network/Interfaces" >}}).
...
For more information, see [Block Shares (iSCSI)]({{< ref "/scale/shares/iscsi" >}}).

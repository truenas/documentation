...
{{< trueimage src="/images/TrueCommand/2.3.1/ConfigureClusterAssociateVIPs.png" alt="Configure Associate VIP" id="Configure Associate VIPs" >}}
...
1. Connected to the same network as the clustering environment, open **File Explorer**.
   ...
   {{< trueimage src="/images/TrueCommand/2.2/WindowsFileExplorereAccessClusterShare.png" alt="Cluster Volume Share Options" id="Cluster Volume Share Options" >}}

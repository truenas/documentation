...
<div style="display: none;" id="requirements-tab-content-source">
  ...
  * At this time, the appliance supports backup and recovery operations for vSphere and [Hyper-V]({{< ref "/Solutions/Integrations/Hyper-V" >}}) virtualization platforms only.

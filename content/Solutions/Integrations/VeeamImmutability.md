...
* Deploy the MinIO Enterprise app.
  ...
  To deploy a cluster follow the instructions in the [MinIO MNMD tutorial]({{< ref "/truenasApps/EnterpriseApps/MinIO/ConfigMinIOEnterpriseMNMD" >}}).
...
Follow the instructions in the [MinIO Enterprise tutorial]({{< ref "/TruenasApps/EnterpriseApps/MinIO" >}}) for a single system deployment, or [MinIO Enterprise MNMD tutorial]({{< ref "/TruenasApps/EnterpriseApps/MinIO/ConfigMinIOEnterpriseMNMD" >}}) to install and deploy the MinIO enterprise train app in a MNMD configuration. TrueNAS and MinIO provide the S3 compatible object storage for Veeam.

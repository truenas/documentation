...
title: "11.3-RC1"
weight: 25
aliases: [/releasenotes/core/freenas/11.3/11.3rc1/]
---
...
After an iocage dataset has been destroyed, it will need to be re-created with the CLI command iocage activate && iocage list before using jails and plugins again. For additional details please refer to [NAS-104254](https://ixsystems.atlassian.net/browse/NAS-104254).

...
| **Certificate** | Select an SSL (CORE) [certificate]({{< relref "Certificates.md" >}}) (SCALE) [certificate]({{< relref "CertificatesSCALE.md" >}}) created or imported in (CORE) **System > Certificates > Add** or (SCALE) **Credentials > Certificates** for secure S3 connections. |

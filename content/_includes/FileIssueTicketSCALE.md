...
* Log into Jira and use **Create** to open a new ticket (see [Issue Reporting](https://www.truenas.com/docs/contributing/issuereporting/jiraissuereporting/) for more information).

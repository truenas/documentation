...
Converting to a custom app direct editing to YAML configuration file for the app using the [Custom App Screens]({{< relref "/SCALEUIReference/Apps/InstallCustomAppScreens.md" >}}).

...
| **Usage Collection** | Enables sending anonymous usage statistics to iXsystems when selected. For more information about what usage data is collected, see the [TrueNAS Data Collection Statement]({{< relref "/GettingStarted/UserAgreements/DataCollectionStatement.md" >}}). |

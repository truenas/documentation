...
{{< trueimage src="/images/SCALE/23.10/UPSServiceSettingsGeneralOptions.png" alt="UPS Options" id="UPS Options" >}}
...
{{< trueimage src="/images/SCALE/23.10/UPSServicesSettingsShutdown.png" alt="UPS Service Shutdown Settings" id="UPS Service Shutdown Settings" >}}
...
{{< trueimage src="/images/SCALE/23.10/UPSServiceSettingsOtherOptions.png" alt="UPS Service Other Options" id="UPS Service Other Options" >}}

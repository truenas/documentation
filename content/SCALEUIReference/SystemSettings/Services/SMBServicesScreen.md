...
{{< trueimage src="/images/SCALE/22.12/SMBServiceOptionsSCALE.png" alt="SMB Service Basic Options" id="- SMB Service Basic Options" >}}
...
{{< trueimage src="/images/SCALE/22.12/SMBServiceAdvancedSCALE.png" alt="SMB Service Advanced Options" id="- SMB Service Advanced Options" >}}

...
{{< trueimage src="/images/SCALE/22.12/NetworkScreenWithIPMI.png" alt="Network with IPMI" id="Network screen with IPMI channels." >}}
...
{{< trueimage src="/images/SCALE/22.12/IPMIConfigurationScreen.png" alt="IPMI Configuration Screen" id="IPMI Configuration Screen." >}}

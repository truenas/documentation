...
**Close** closes the dialog and returns to the **Disks** screen.
...
| Setting | Description |
|---------|-------------|
| **Critical** | Enter a threshold temperature in Celsius. If the drive temperature is higher than this value, it creates a LOG_CRIT level log entry and sends an email to the address entered in the [Alerts]({{< ref "/SCALEUIReference/TopToolbar/Alerts/EmailScreens" >}}). Enter **0** to disable this check. |

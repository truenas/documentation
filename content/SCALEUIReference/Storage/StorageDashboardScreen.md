...
If TrueNAS detects problems during the scrub, it either corrects them automatically or generates an [alert]({{< relref "/SCALEUIReference/TopToolbar/Alerts/AlertSettingsScreen.md" >}}) in the web interface.
...
## Upgrade Dialog
The **Upgrade** button displays on the **Storage Dashboard** after an upgrade to a new release if it includes changes to feature flags.

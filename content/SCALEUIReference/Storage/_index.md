...
* {{< expand "Expand (Click to expand)" "v" >}}
  ...
  This is used as the final step to resize disk partitions when [expanding a pool capacity with disk replacements]({{< ref "ManagePoolsScale.md#replacing-disks-to-expand-a-pool" >}}).

...
{{< trueimage src="/images/SCALE/22.12/AllUsersScreenBuiltInSCALE.png" alt="Local User Built-in Accounts" id="Local User Built-in Accounts" >}}
...
{{< trueimage src="/images/SCALE/22.12/UserScreenUserDetails.png" alt="Local User Details" id="Local User Details" >}}
...
{{< trueimage src="/images/SCALE/22.12/EditUserIdentificationSCALE.png" alt="Edit User Identification Settings" id="Edit User Identification Settings" >}}
...
{{< trueimage src="/images/SCALE/22.12/AddUser-UserIDAndGroupSettings.png" alt="Add User User ID and Groups Settings" id="Add User User ID and Groups Settings" >}}
...
{{< trueimage src="/images/SCALE/22.12/AddUserHomeDirPermSCALE.png" alt="Add User Directories, Permissions and Authentication Settings" id="Add User Directories, Permissions and Authentication Settings" >}}

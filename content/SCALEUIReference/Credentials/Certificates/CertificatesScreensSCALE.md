...
{{< /hint >}}
Many of the settings in the **Add Certificate** wizard are the same as those in the **[Add CA]({{< ref "CAScreensSCALE" >}})** and **[Add Certificate Signing Request]({{< ref "CSRScreensSCALE" >}})** wizards.

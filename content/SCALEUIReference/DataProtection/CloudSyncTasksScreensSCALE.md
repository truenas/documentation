...
**Manage Credentials** opens the [Backup Credentials]({{< relref "/SCALEUIReference/Credentials/BackupCredentials/" >}}) screen.
...
| **Pre-Script** | For advanced users. Sets a script to execute before running sync to what is entered. See the [Cloud Sync tutorial]({{< ref "/SCALETutorials/DataProtection/CloudSyncTasks/" >}}) for more information. |
| **Post-Script** | For advanced user. Sets a script to execute after running sync to what is entered. See the [Cloud Sync tutorial]({{< ref "/SCALETutorials/DataProtection/CloudSyncTasks/" >}}) for more information. |

...
| `full_name` | String | Yes | Sets a description for the user, such as a first and last name. <br> Ex. `full_name="Test User"` <br> &emsp; Where `Test User` is the user's full name. |

...
![Aptio BIOS Setup Heat](/images/AptioBIOSSetupHeat.png "Aptio BIOS Setup Heat")
   <br><br>

3. Press the <kbd>right arrow</kbd> to go to the `H/W Monitor` tab:
4. 
![Aptio BIOS Setup Hardware Monitor](/images/AptioBIOSSetupHWMonitor.png "Aptio BIOS Setup Hardware Monitor")
   <br><br>
